...
namespace DSAConcepts{
    public static class ArrayLeader
    {
        public static List<int> Leaders(int[] arr, int n)
        {
            #region Solution 1 with O(n2)
            ...
            #region Solution 2 with O(n) --- Optimized
                List<int> result = new List<int>();
                int max = arr[n-1];
                result.Add(max);
        ...
        public static void Print(List<int> result){
            System.Console.Write("Leaders are : ");
